...
static int findelements(int res,int array[],int N,int M)
	...
	public static void main(String[]args)
	{
		...
		String items[]={"MI Band:999","Sandwich Toaster:2195","Cult Pass:2299","Scale:4999",
		"Fitbit Plus:7980","Microwave Oven:9800","Alexa:9999","Digital Camera:11101","Ipods:22349","Macbook Pro:229900"};
		int N= array.length;
		...
		for(int i=startindex;i<startindex+M;i++)
			System.out.println("\n");
		System.out.println("And the difference between the chosen goodies with heighest price and the lowest price is:"+result);
	}
}
